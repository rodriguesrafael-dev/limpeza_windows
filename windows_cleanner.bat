...
echo [6/8] Executando verificação de arquivos do sistema (SFC)...
sfc /scannow
...
echo [8/8] Verificando disco com CHKDSK (pode agendar para o próximo boot)...
chkdsk C: /f /r

:: Executando ferramenta de remocao de software malicioso
echo [+] Iniciando MRT (Ferramenta de Remoção de Software Malicioso)...
start mrt
